...
ni_rx_sds=["state", "header_flit", "path_flit", "app_id", "app_id_valid", "crypto_tag", "crypto_tag_valid", "key_periph", "burst_size", "hermes_service", "hermes_service_valid", "end_of_handling", "hermesControl", "tableControl", "send_ack"]
