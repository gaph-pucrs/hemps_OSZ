...
if __name__ == "__main__":
    # Load data
    probes = read_probe_data("simulation_data/size_10_delay_3_payload_30_probes.txt")
    ht_periods = parse_ht_times("simulation_data/size_10_delay_3_payload_30_hts.txt")
    
    # Apply filters
    ht_pos = "0x00000401"  # Example: filter by specific position
    ht_dir = "N"           # Example: filter by East direction
